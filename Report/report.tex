...
Figure \ref{fig:attackexample4} has a graphic description of what this triangulation achieves. An attacker would need to disrupt and replay many reports at the same time, which could be extremely difficult in an environment where the devices are moving in an unpredictable way.\\
